...
import { getLocalAdminData, AdminStats } from "@/features/admin/services/localDataService";
...
export default function AdminDashboardPage() {
  ...
  // Si está cargando, mostramos un estado vacío o skeleton
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-400">Datos en tiempo real del sistema.</p>
      </div>

      {/* Grid de Estadísticas */}
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {[
          { title: "Usuarios Detectados", val: stats.totalUsers, icon: Users },
          ...
          { title: "Estado Sistema", val: "Activo", icon: Activity },
        ].map((item, i) => (
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-4 bg-card border-slate-800/60">
          <CardHeader>
            ...
            <CardDescription className="text-slate-400">Creación de combinaciones por día de la semana</CardDescription>
          </CardHeader>
        ...
        <Card className="col-span-3 bg-card border-slate-800/60">
          <CardHeader>
            ...
            <CardDescription className="text-slate-400">Usuarios encontrados en memoria</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-8">
              {stats.userList.length === 0 ? (
                <p className="text-sm text-slate-500">No hay usuarios registrados aún.</p>
              ) : (
                  ...
                  <div key={i} className="flex items-center">
                    ...
                    <div className="ml-4 space-y-1">
                      ...
                      <p className="text-xs text-slate-500">
                        {user.combinationsCount} combinaciones • Última: {user.lastActive}
                      </p>
                    </div>
                  </div>
                ))
